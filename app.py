...
from src.features.content_based_filtering import content_recomendation
from scipy.sparse import load_npz
from src.features.Hybrid_recomendation_system import HybridRecommenderSystem
import pandas as pd
...
# load the data
cleaned_data_path = "data/processed/cleaned_song_data.csv"
songs_data = pd.read_csv(cleaned_data_path)

# load the transformed data
transformed_data_path = "data/processed/transformed.npz"
transformed_data = load_npz(transformed_data_path)

# load the track ids
track_ids_path = "data/filtered/track_ids.npy"
track_ids = load(track_ids_path,allow_pickle=True)

# load the filtered songs data
filtered_data_path = "data/filtered/colab_filtered_data.csv"
...
transformed_hybrid_data_path = "data/filtered/transform_hybrid_data.npz"
...
if filtering_type == 'Content-Based Filtering':
    if st.button('Get Recommendations'):
        if ((songs_data["name"] == song_name) & (songs_data['artist'] == artist_name)).any():
            ...
            recommendations = content_recomendation(song_name=song_name,
